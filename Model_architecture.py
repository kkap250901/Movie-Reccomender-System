...
#------------------------------------------User embedddings-------------------------------------------------------------------------------------#
        self.embeddings_user_id = Embeddings(int(users.user_id.max())+1, int(math.sqrt(users.user_id.max()))+1)
        self.embeddings_age_group = Embeddings(users.age_group.nunique(), int(math.sqrt(users.age_group.nunique())))
        self.embeddings_user_sex = Embeddings(users.sex.nunique(), int(math.sqrt(users.sex.nunique())))
        self.embeddings_user_occupation = Embeddings(users.occupation.nunique(), int(math.sqrt(users.occupation.nunique())))
